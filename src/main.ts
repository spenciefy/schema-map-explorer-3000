...
app.innerHTML=`
  ...
  <main>
    ...
    <aside id="rider-settings" class="rider-settings" aria-labelledby="settings-title" hidden>
      ...
      <fieldset class="ecology-settings"><legend>Local nature</legend><p id="ecology-description"></p><label class="settings-visibility"><span>Show wildlife</span><input id="wildlife-visible" type="checkbox" checked /></label><p class="ecology-note">Regional interpretation, not recorded sightings.</p></fieldset>
