...
app.innerHTML=`
  ...
  <footer><span><a href="https://www.openstreetmap.org/copyright" target="_blank" rel="noopener">© OpenStreetMap contributors</a><span>·</span><a href="https://registry.opendata.aws/terrain-tiles/" target="_blank" rel="noopener">Mapzen terrain</a></span><span class="maker-credit">Made in an evening by <a href="https://spenceryen.com" target="_blank" rel="noopener">Spencer</a> and GPT-6 Astra</span><span class="rotation-hint">Hold ⌘ and drag to rotate</span></footer>
...
window.addEventListener('terrain-ready',(event)=>{$('#scene').setAttribute('aria-busy','false');$('#terrain-status').classList.remove('loading');renderRiderSettings();const detail=(event as CustomEvent).detail;terrainData=detail.data;const source=terrainData!.source;
 for(const link of document.querySelectorAll<HTMLAnchorElement>('footer a[href*="terrain-tiles"],footer a[data-terrain-source],.mobile-map-attribution a[data-terrain-source],.mobile-map-attribution a[href*="terrain-tiles"]')){link.dataset.terrainSource='true';link.href=source.terrainAttribution;link.textContent=detail.id==='iwanai'?'GSI · edited':'Mapzen terrain';}
